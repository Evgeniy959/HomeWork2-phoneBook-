...
namespace HomeWork2_phoneBookGroup_
{
    class Program
    {
        static void Main()
        {
            ...
            do
            {
                ...
                Console.WriteLine("8. Добавить группу");
        ...
        static void AddGroup(Dictionary<string, string> dictionary, Dictionary<string, string> group)
        {
            var flagAdd = false;
            //var group = DataGroup();
            var name = DataName();
            ...
            {
                dictionary.Add(phone, name);
                newperson.Add(dictionary, group);
                //dictionary.Add(group, newperson);
            }
        }
        static void AddFile()
        {
